...
// BinDigits erwartet eine Zahl n und eine Basis. Liefert eine Liste von Ziffern zur basis
func BinDigits(n int) []int {
	...
	for n != 0 {
		...
		//result = append([]int{digit}, result...) // Direkt umgekehrt anhängen
...
// 0 Falls die Anzahl die Anzahl der Einsen in der Binärdarstellung von n gerade ist
